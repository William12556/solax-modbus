...
prompt_info:
  ...
  target_profile: ""  # engine, claude_code, or claude_omlx — governs tactical_brief requirement
  date: ""
...
tactical_brief: ""
# REQUIRED when target_profile is engine — must be populated before issuing
# Engine command. Not consumed by claude_code or claude_omlx profiles; may
...
properties:
  ...
  tactical_brief:
    type: string
    minLength: 1
    description: "Required when prompt_info.target_profile is engine — concise engine task payload, must not be empty when present. Used by orchestrator in preference to full document. Not consumed by claude_code or claude_omlx profiles."
